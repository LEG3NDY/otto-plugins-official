/**
 * Adapted from the public anthropics/skills `algorithmic-art` template and
 * modified for Otto/LEG3NDY branding and workflow guidance.
 */
/**
 * ═══════════════════════════════════════════════════════════════════════════
...
function fadeBackground(opacity) {
    fill(250, 249, 245, opacity); // Otto light with alpha
    noStroke();
